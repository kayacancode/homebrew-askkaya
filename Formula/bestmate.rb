class Bestmate < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/kayacancode/homebrew-askkaya/releases/download/v0.8.0/bestmate-darwin-arm64"
      sha256 "c03a31482d94eddd090c244257cf9794af9b15486b46205d01f97dcad8737fce"
    else
      url "https://github.com/kayacancode/homebrew-askkaya/releases/download/v0.8.0/bestmate-darwin-amd64"
