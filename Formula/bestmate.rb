class Bestmate < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/kayacancode/askkaya/releases/download/v0.4.0/bestmate-darwin-arm64"
      sha256 "401efed2d56bfc0afa7d5296d36fe3e08c2ff66f155c4afa69933f3960ce4515"
    else
      url "https://github.com/kayacancode/askkaya/releases/download/v0.4.0/bestmate-darwin-amd64"
